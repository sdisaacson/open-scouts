...
const buttonVariants = tv({
  base: [
    // base
    "relative inline-flex items-center justify-center whitespace-nowrap rounded-6 border px-3 py-2 text-center text-sm  shadow-xs transition-all duration-100 ease-in-out",
    // disabled
