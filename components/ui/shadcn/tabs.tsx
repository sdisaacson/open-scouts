...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-6  p-1 text-zinc-800 dark:bg-zinc-800 dark:text-zinc-400",
      className,
    )}
    {...props}
  />
